...
<GoToDocsButton
  href="https://lokale.io/android-sdk/integrations/views/installation"
  style={{ float: 'right' }}
/>

To read full documentation about Lokale for Android Views, visit [docs](https://lokale.io/android-sdk/integrations/views/installation).
...
[libraries]
lokale = { group = "io.lokale.mobile-kotlin-sdk", name = "core", version.ref = "lokale" }
```
...
val text = lokale.t(context, R.string.string_key)

// Get a translation with fallback to Android resources with parameters
val textWithParams = lokale.t(context, R.string.string_with_params, "param1", "param2")
